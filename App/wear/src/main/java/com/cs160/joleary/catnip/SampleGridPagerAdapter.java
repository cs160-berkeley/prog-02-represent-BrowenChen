...
//        Custom adapter
        mRows.add(new Row(new CustomFragment(R.string.welcome_title, R.string.welcome_text)));
        mRows.add(new Row(new CustomFragment(R.string.about_title, R.string.about_text)));
        mRows.add(new Row(new CustomFragment(R.string.cards_title, R.string.cards_text)));


        mRows.add(new Row(cardFragment(R.string.dismiss_title, R.string.dismiss_text)));
        mDefaultBg = new ColorDrawable(3);
        mClearBg = new ColorDrawable(5);
    }
